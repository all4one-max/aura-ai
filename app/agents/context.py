...
def context_agent(
    ...
    # the problem with general qna is if i use last message then it can be a clarification
    # for a shopping message as well then how do you know if it is a continuation to already going conversation
    # or a genearal message
    ...
    extracted_data: ChatQueryExtraction = extract_chat_query_tool(last_message)
